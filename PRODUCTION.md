...
This repository is maintained as a **production portfolio web application**.

## Production purpose

publish the canonical recruiter-facing site from evidence-backed content and assets.

## Release gate

A release is promotable only when content verification, type check, lint, production build/export, Lighthouse budget, and deployment pass.

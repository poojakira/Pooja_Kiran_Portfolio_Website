...
const WORLDS: World[] = [
  ...
  },
  {
    ...
    evidence: ["648 passing tests in the current validated suite", "50+ prompt-injection detection patterns", "Elastic / SIEM detection content", "Hash-chained audit evidence"],
  ...
  },
  {
    ...
    evidence: ["25 deterministic IAM rule IDs", "235 passing tests in the validated suite", "SARIF 2.1.0 output", "CI policy gates and scoped performance checks"],
  ...
  },
  {
    ...
    evidence: ["211 passing tests in the current validated suite", "Committed red-team fixtures", "Pickle / SafeTensors / GGUF / ONNX / Keras paths", "Provenance and impersonation checks"],

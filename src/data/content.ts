...
export const EXPERIENCE: ExperienceItem[] = [
  {
    ...
    bullets: [
      ...
      "Validated the MCP gateway with 629 passing tests at 78.47% coverage and documented LLM generalization with grouped F1 0.97 versus novel-phrasing OOD F1 0.8302.",
    ],
  },
  {

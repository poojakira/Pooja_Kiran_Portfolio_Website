...
export const universeWorlds: UniverseWorld[] = [
  ...
  },
  {
    ...
    evidence: ["648 passing tests", "79.61% statement coverage", "55 injection patterns", "9 Elastic rules"],
  ...
  },
  {
    ...
    evidence: ["25 deterministic rule IDs", "235 passed / 3 skipped", "SARIF 2.1.0", "scoped CI performance gates"],
  ...
  },
  {
    ...
    evidence: ["211 passed / 1 skipped", "12/12 core fixtures", "18/18 extended variants", "3/3 large-scale fixtures"],
